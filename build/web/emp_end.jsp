<%-- 
    Document   : emp_end
    Created on : 26 Jun, 2015, 11:36:34 AM
    Author     : Akach
--%>
    ...
    <div class="col-lg-9">
        <div class="panel panel-default">
  			...
  			<div class="panel-body">
                            ...
                            <form class="form-horizontal" method="post" action="EmpFinController">
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <select class="form-control" id="select" name="shifts">
	...
	<div class="form-group">
        <label for="select" class="col-lg-2 control-label">Shift</label>
            <div class="col-lg-10">
