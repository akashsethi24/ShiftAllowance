<%-- 
    Document   : mgr_home
    Created on : 17 Jul, 2015, 4:41:07 PM
    Author     : Akach
--%>
...
try{
 ...
 rs= Manager.selectAllmonth(offset, limit,month);
}
catch(Exception e){}
%>
    	...
    	<div class="col-lg-3">
         <div class="panel active1">
	    	 ...
	    	 <div class="list-group">
  				<a href="mgr_home.jsp" class="list-group-item active">
    ...
    <div class="col-lg-9">
        <div class="panel panel-default">
  			...
  			<div class="panel-body">
                ...
                <form class="form-horizontal" mehtod="post" action="MgrViewController">
  <fieldset>
